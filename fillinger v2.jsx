/* 
  ...
  Author: A Jongware Script (Circle fill) & Modified by Md Rasel Rahman Rocky
  Program version: Adobe Illustrator CC+
  Name: fillinger v2.jsx;

  Modify and refactoring: Md Rasel Rahman Rocky find me on https://facebook.com/raselrahmanrocky
  
  
  MODIFIED TO TREAT A FILLER GROUP AS A SINGLE OBJECT BY MD RASEL RAHMAN ROCKY

  Copyright (c) 29 Auguest 2025
...
if (app.documents.length && app.selection.length < 2) {
    ...
    function startAction(){
        ...
        // ### MODIFICATION START ###
        // The original logic here would look inside a group.
        // We have changed it to simply use the items as they are selected.
        // This ensures a group is treated as a single object.
        var placeObject = items;
        // ### MODIFICATION END ###
